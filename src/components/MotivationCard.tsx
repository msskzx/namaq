...
const MotivationCard: React.FC<MotivationCardProps> = ({ icon, title, desc, url }) => {
  return (
    <Link href={url} className="block">
      <div className="relative group bg-white dark:bg-indigo-800 rounded-xl shadow-lg p-6 flex flex-col items-center justify-center border border-amber-400 transition-transform hover:-translate-y-1 hover:shadow-2xl cursor-pointer min-h-[140px]">
