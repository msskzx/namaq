...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-8 border-t border-indigo-700">
            <div className="container mx-auto px-4">
                ...
                <div className="mt-6 pt-6 border-t border-indigo-500 text-center text-sm opacity-80">
                    {currentLanguage === 'ar' ? (
                        <>
                            <p dir="rtl">تعلم اللغة العربية والتاريخ الإسلامي وتعاليم النبي محمد ﷺ</p>
                            <div className="mt-4">
                                <a href="/privacy" className="text-indigo-300 hover:text-white transition-colors" dir="rtl">
                                    سياسة الخصوصية
                                </a>
                            </div>
                        </>
                        ...
                        <>
                            ...
                            <div className="mt-4">
                                <a href="/privacy" className="text-indigo-300 hover:text-white transition-colors">
                                    Privacy Policy
                                </a>
                            </div>
                        </>
