...
const PersonNameCard: React.FC<PersonNameCardProps> = ({ person, language }) => {
  return (
    <Link href={`/people/${person.slug}`} className="block">
      <div className="bg-white dark:bg-indigo-950 border border-amber-400 rounded-lg p-4 shadow hover:shadow-xl hover:scale-105 transition-transform duration-200 cursor-pointer text-center">
