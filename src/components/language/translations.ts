const translations = {
  en: {
    ...
    kunya: 'Kunya',
    sex: 'Sex',
    sexValues: { MALE: 'Male', FEMALE: 'Female' },
    ...
    relationTypes: {
      ...
      MAWLA: 'Mawla',
      PATRON: 'Patron',
      MILK_BROTHER: 'Milk brother',
      MILK_SISTER: 'Milk sister',
      CALLED_TO_ISLAM: 'Called to Islam',
      ANSWERED_CALL_OF: 'Answered the call of',
      CONCUBINE: 'Concubine',
  ...
  ar: {
    ...
    kunya: 'الكنية',
    sex: 'الجنس',
    sexValues: { MALE: 'ذكر', FEMALE: 'أنثى' },
    appearance: 'الهيئة',
    virtues: 'المناقب',
    ...
    relationTypes: {
      ...
      MAWLA: 'مولى',
      PATRON: 'مُعتِق',
      MILK_BROTHER: 'أخوه من الرضاعة',
      MILK_SISTER: 'أخته من الرضاعة',
      CALLED_TO_ISLAM: 'دعاه إلى الإسلام',
      ANSWERED_CALL_OF: 'أسلم بدعائه',
      CONCUBINE: 'جارية',
    ...
    graph: {
      ...
      exploreSubject: 'استكشاف',
      globalRelationships: 'العلاقات في الرسم كله',
      globalRelationshipsHint: 'إظهار الصلات المطابقة في الاستكشاف الحالي.',
      deselectSubject: 'إلغاء التحديد',
      showFullGraph: 'عرض الرسم الكامل',
      startOver: 'البدء من جديد',
      retry: 'إعادة المحاولة',
      collapseBranch: 'طي الفرع',
      removeSubject: 'إخفاء العقدة',
