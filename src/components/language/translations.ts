const translations = {
  en: {
    ...
    graph: {
      ...
      removeSubject: 'Remove from exploration',
      keepOnlySelected: 'Keep only this subject',
  ...
  ar: {
    ...
    graph: {
      ...
      removeSubject: 'إزالة من الاستكشاف',
      keepOnlySelected: 'الإبقاء على هذا العنصر فقط',
