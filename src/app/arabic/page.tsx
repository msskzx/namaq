  ...
  return (
    <div className="container mx-auto p-4 md:p-8" dir="rtl">
      <div className="text-center my-12 md:my-16">
        <h1 className="text-4xl md:text-6xl font-black text-blue-600 dark:text-blue-400 tracking-tight arabic-text">
          اللغة العربية
        </h1>
        <div className="mt-8 flex flex-row items-center justify-center gap-4 bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-2xl p-8 mx-auto transition-colors duration-300">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 max-w-2xl mx-auto">
            <p className="text-2xl font-bold text-gray-700 dark:text-gray-200 arabic-text">
              لغة عالمية يتحدث بها أكثر من
            </p>
            <p className="text-5xl md:text-8xl font-extrabold text-blue-600 dark:text-blue-400 my-4 arabic-text">
              422 مليون
            </p>
            <p className="text-2xl font-bold text-gray-700 dark:text-gray-200 arabic-text mt-6">
              شخص حول العالم
            </p>
          </div>
          <Image
