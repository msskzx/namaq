...
export default function SpecialsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 py-12" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-200 mb-8 text-base sm:text-lg font-arabic max-w-3xl mx-auto">
          {language === 'ar'
