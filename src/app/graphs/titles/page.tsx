    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-center text-gray-800 dark:text-indigo-100 mb-10 text-base sm:text-lg md:text-xl font-arabic max-w-4xl mx-auto" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                {language === 'ar'
                    ? 'استكشف الألقاب التي حملها الصحابة والأنبياء من خلال رسم بياني تفاعلي يربط كل لقب بمن حمله من الشخصيات.'
                    : 'Explore the titles held by companions and prophets through an interactive diagram linking every title to the people who carried it.'}
            </p>
