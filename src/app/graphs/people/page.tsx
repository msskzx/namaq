        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-center text-gray-800 dark:text-indigo-100 mb-10 text-base sm:text-lg md:text-xl font-arabic max-w-4xl mx-auto" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                {language === 'ar'
                    ...
                    : 'Explore the family and relation graph of Prophet Muhammad ﷺ and all companions and prophets through an interactive diagram showing children, daughters, spouses, relatives and more. This feature is available for every person on the site.'}
            </p>
            <GraphCanvas />
        </div>
    );
