...
const prophetMuhammad = {
  ...
  relations: [
    ...
    { type: 'HUSBAND', inverse: 'WIFE', to: 'umm-salamah', claims: ['prophet/wife-umm-salamah'] },
    { type: 'HUSBAND', inverse: 'WIFE', to: 'zaynab-bint-jahsh', claims: ['prophet/wife-zaynab-jahsh'] },
    { type: 'HUSBAND', inverse: 'WIFE', to: 'juwayriyah-bint-al-harith', claims: legacyUnreviewed },
    { type: 'HUSBAND', inverse: 'WIFE', to: 'umm-habibah', claims: ['prophet/wife-umm-habibah'] },
    { type: 'HUSBAND', inverse: 'WIFE', to: 'safiyyah-bint-huyayy', claims: ['prophet/wife-safiyyah'] },
