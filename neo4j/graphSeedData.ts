...
import {
  peopleQueries as companionAncestryPeopleQueries8,
  peopleRelationsQueries as companionAncestryPeopleRelationsQueries8,
} from './graphSeedData10';
import {
  peopleQueries as companionAncestryPeopleQueries9,
  peopleRelationsQueries as companionAncestryPeopleRelationsQueries9,
} from './graphSeedData11';
import {
  peopleQueries as companionAncestryPeopleQueries10,
  peopleRelationsQueries as companionAncestryPeopleRelationsQueries10,
} from './graphSeedData12';
import {
  peopleQueries as companionAncestryPeopleQueries11,
  peopleRelationsQueries as companionAncestryPeopleRelationsQueries11,
} from './graphSeedData13';
import {
  peopleQueries as companionAncestryPeopleQueries12,
  peopleRelationsQueries as companionAncestryPeopleRelationsQueries12,
} from './graphSeedData14';
...
export const corePeopleQueries = [
    ...
    'CREATE (:Person { name: "فاطمة بنت محمد", slug: "fatimah-bint-muhammad", nameTransliterated: "Fatimah bint Muhammad" });',
...
export const corePeopleRelationsQueries = [
    ...
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "umar-ibn-al-khattab"}) CREATE (from)-[:SON_IN_LAW]->(to);',
    'MATCH (from:Person {slug: "uthman-ibn-affan"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:SON_IN_LAW]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "uthman-ibn-affan"}) CREATE (from)-[:FATHER_IN_LAW]->(to);',
    'MATCH (from:Person {slug: "ali-ibn-abi-talib"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:SON_IN_LAW]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "ali-ibn-abi-talib"}) CREATE (from)-[:FATHER_IN_LAW]->(to);',
    'MATCH (from:Person {slug: "az-zubayr-ibn-al-awwam"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:PATERNAL_COUSIN]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "az-zubayr-ibn-al-awwam"}) CREATE (from)-[:PATERNAL_COUSIN]->(to);',
    'MATCH (from:Person {slug: "khadijah-bint-khuwaylid"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "khadijah-bint-khuwaylid"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "aisha-bint-abi-bakr"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "aisha-bint-abi-bakr"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "hafsa-bint-umar"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "hafsa-bint-umar"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "zaynab-bint-khuzaymah"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "zaynab-bint-khuzaymah"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "umm-salamah"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "umm-salamah"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "zaynab-bint-jahsh"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "zaynab-bint-jahsh"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "juwayriyah-bint-al-harith"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "juwayriyah-bint-al-harith"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "umm-habibah"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "umm-habibah"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "safiyyah-bint-huyayy"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "safiyyah-bint-huyayy"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "maymunah-bint-al-harith"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "maymunah-bint-al-harith"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "sawdah-bint-zamah"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "sawdah-bint-zamah"}) CREATE (from)-[:HUSBAND]->(to);',
    'MATCH (from:Person {slug: "fatimah-bint-muhammad"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:DAUGHTER]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "fatimah-bint-muhammad"}) CREATE (from)-[:FATHER]->(to);',
    ...
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "hamzah-ibn-abd-al-muttalib"}) CREATE (from)-[:PATERNAL_NEPHEW]->(to);',
    'MATCH (from:Person {slug: "abu-talib"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:PATERNAL_UNCLE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "abu-talib"}) CREATE (from)-[:PATERNAL_NEPHEW]->(to);',
    'MATCH (from:Person {slug: "al-abbas-ibn-abd-al-muttalib"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:PATERNAL_UNCLE]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "al-abbas-ibn-abd-al-muttalib"}) CREATE (from)-[:PATERNAL_NEPHEW]->(to);',
    'MATCH (from:Person {slug: "al-hasan-ibn-ali"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:GRANDSON]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "al-hasan-ibn-ali"}) CREATE (from)-[:GRANDFATHER]->(to);',
    'MATCH (from:Person {slug: "al-husayn-ibn-ali"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:GRANDSON]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "al-husayn-ibn-ali"}) CREATE (from)-[:GRANDFATHER]->(to);',
    'MATCH (from:Person {slug: "ali-ibn-abi-talib"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:PATERNAL_COUSIN]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "ali-ibn-abi-talib"}) CREATE (from)-[:PATERNAL_COUSIN]->(to);',
    'MATCH (from:Person {slug: "abdullah-ibn-jaafar"}), (to:Person {slug: "prophet-muhammad"}) CREATE (from)-[:PATERNAL_COUSIN]->(to);',
    'MATCH (from:Person {slug: "prophet-muhammad"}), (to:Person {slug: "abdullah-ibn-jaafar"}) CREATE (from)-[:PATERNAL_COUSIN]->(to);',
    'MATCH (from:Person {slug: "fatimah-bint-muhammad"}), (to:Person {slug: "ali-ibn-abi-talib"}) CREATE (from)-[:WIFE]->(to);',
    'MATCH (from:Person {slug: "ali-ibn-abi-talib"}), (to:Person {slug: "fatimah-bint-muhammad"}) CREATE (from)-[:HUSBAND]->(to);',
    ...
    'MATCH (from:Person {slug: "fatimah-bint-muhammad"}), (to:Person {slug: "al-hasan-ibn-ali"}) CREATE (from)-[:MOTHER]->(to);',
    'MATCH (from:Person {slug: "al-hasan-ibn-ali"}), (to:Person {slug: "fatimah-bint-muhammad"}) CREATE (from)-[:SON]->(to);',
    ...
    'MATCH (from:Person {slug: "fatimah-bint-muhammad"}), (to:Person {slug: "al-husayn-ibn-ali"}) CREATE (from)-[:MOTHER]->(to);',
    'MATCH (from:Person {slug: "al-husayn-ibn-ali"}), (to:Person {slug: "fatimah-bint-muhammad"}) CREATE (from)-[:SON]->(to);',
    ...
    'MATCH (from:Person {slug: "umm-kulthum-bint-ali"}), (to:Person {slug: "fatimah-bint-muhammad"}) CREATE (from)-[:DAUGHTER]->(to);',
    'MATCH (from:Person {slug: "fatimah-bint-muhammad"}), (to:Person {slug: "umm-kulthum-bint-ali"}) CREATE (from)-[:MOTHER]->(to);',
    ...
    'MATCH (from:Person {slug: "zaynab-bint-ali"}), (to:Person {slug: "fatimah-bint-muhammad"}) CREATE (from)-[:DAUGHTER]->(to);',
    'MATCH (from:Person {slug: "fatimah-bint-muhammad"}), (to:Person {slug: "zaynab-bint-ali"}) CREATE (from)-[:MOTHER]->(to);',
...
export const peopleQueries = uniqueBy(
  [
    ...
    ...companionAncestryPeopleQueries8,
    ...companionAncestryPeopleQueries9,
    ...companionAncestryPeopleQueries10,
    ...companionAncestryPeopleQueries11,
    ...companionAncestryPeopleQueries12,
  ],
  nodeKey,
);
...
export const peopleRelationsQueries = uniqueBy(
  [
    ...
    ...companionAncestryPeopleRelationsQueries8,
    ...companionAncestryPeopleRelationsQueries9,
    ...companionAncestryPeopleRelationsQueries10,
    ...companionAncestryPeopleRelationsQueries11,
    ...companionAncestryPeopleRelationsQueries12,
  ],
  relationKey,
);
