...
export const peopleQueries = [
  ...
  'CREATE (:Person { name: "عدنان", slug: "adnan", fullName: "عدنان" });',
...
export const peopleRelationsQueries = [
  ...
  'MATCH (from:Person {slug: "maad-ibn-adnan"}), (to:Person {slug: "adnan"}) CREATE (from)-[:SON]->(to);',
  'MATCH (from:Person {slug: "adnan"}), (to:Person {slug: "maad-ibn-adnan"}) CREATE (from)-[:FATHER]->(to);',

  // Abu Bakr As-Siddiq
  'MATCH (from:Person {slug: "abu-bakr-as-siddiq"}), (to:Person {slug: "uthman-ibn-amir"}) CREATE (from)-[:SON]->(to);',
  'MATCH (from:Person {slug: "uthman-ibn-amir"}), (to:Person {slug: "abu-bakr-as-siddiq"}) CREATE (from)-[:FATHER]->(to);',
  ...
  'MATCH (from:Person {slug: "adi-ibn-kaab"}), (to:Person {slug: "kaab-ibn-luay"}) CREATE (from)-[:SON]->(to);',
  'MATCH (from:Person {slug: "kaab-ibn-luay"}), (to:Person {slug: "adi-ibn-kaab"}) CREATE (from)-[:FATHER]->(to);',
