...
CREATE UNIQUE INDEX "relationship_claims_sourcePersonSlug_targetPersonSlug_relationshipType_sourceId_key" ON "relationship_claims"("sourcePersonSlug", "targetPersonSlug", "relationshipType", "sourceId");
CREATE INDEX "relationship_claims_sourcePersonSlug_targetPersonSlug_relationshipType_reviewStatus_idx" ON "relationship_claims"("sourcePersonSlug", "targetPersonSlug", "relationshipType", "reviewStatus");
