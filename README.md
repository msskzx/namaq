...
- Person pages embed the same graph engine the workspace uses, opened on that person under the shared rule above: every direct relation they have, plus their ancestors and descendants. Its exploration is kept in the component rather than the address bar, so a profile link carries the person and nothing else.
